# main.py - Complete Modified Version
import os
import sys
import locale
...
def init_font_support():
    ...
    print("=== Initializing Font Support ===")

    # 1. Set system encoding
    try:
    ...
    try:
        ...
        try:
            ...
            print("Warning: Unable to set English locale")

    # 3. Register fonts
    from kivy.core.text import LabelBase
    from kivy.config import Config

    # Windows font priority list
    font_priority = [
    ...
    if registered_font:
        ...
        print(f"Default font set to: {registered_font}")
    else:
...
# Call font initialization before importing Kivy
init_font_support()
...
class DailyTracker(TabbedPanel):
    ...
    def update_weather_theme(self):
        ...
        try:
            if hasattr(self, 'weather_manager'):
                # Get weather information (using Shanghai Jiao Tong University coordinates)
                ...
                print(f"Weather theme updated: {weather_type} -> {theme}")
    ...
    def update_theme(self, weather_type):
        ...
        try:
            ...
            print(f"Theme applied: {weather_type}")
